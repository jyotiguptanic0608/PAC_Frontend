...
useEffect(() => {
    localStorage.setItem("chairmanOption", option);
}, [option]);
useEffect(() => {
...
"http://localhost:8080/api/proposals/canGenerateReport"
...
"http://localhost:8080/api/proposals/generateReport",
...
async function chairmanApprove(){

    try{

        await axios.put(

`http://localhost:8080/api/proposals/${approveProposalId}/chairmanApprove`
...
await fetchProposals();
  await checkGenerateButton();
        ...
        setShowChairmanApproveBox(false);

        setApproveProposalId(null);

        setShowChairmanSuccess(true);
...
"http://localhost:8080/api/proposals/approved"
...
{
proposal.status==="CHAIRMAN_APPROVED" &&
...
proposal.file.split(",").map((file,index)=>(
...
onClick={() => {
    setApproveProposalId(proposal.id);
    setShowChairmanApproveBox(true);
}}
...
<div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
    ...
    <div className="bg-white rounded-2xl shadow-2xl w-[450px] p-8">
        ...
        <p className="text-lg text-gray-700">
            Are you sure you want to give the final approval to this proposal?
        </p>
...
<div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
    ...
    <div className="bg-white rounded-2xl shadow-2xl w-[430px] p-8 text-center">
        ...
        <p className="text-gray-700 mb-6">
            This proposal has been successfully approved by the Chairman.
        </p>

        <button
            className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-2 rounded-lg"
            onClick={() => setShowChairmanSuccess(false)}
        >
            OK
        </button>
